...
private:
    string desicion, numSerie, nombre, clasif, duracion, baseDatos, busquedaDatos, modBaseDatos, numSal, nivel, numAsientos, numeroAs, estado, idCines, direccion, estadoCines ;
};
